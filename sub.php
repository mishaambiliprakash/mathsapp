...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-5 col-lg-6 col-xl-6 col-xxl-6">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td></td>
                        <td><button onclick="myButtonClick()" class="btn btn-primary">SUBTRACT</button></td>
                    </tr>
                    <tr>
                        <td>result</td>
                        <td><p id="result"></p></td>
    ...
    <script>
        function myButtonClick(){
            ...
            var getnuma=parseInt(document.getElementById("numa").value)
            var getnumb=parseInt(document.getElementById("numb").value)

            var res=getnuma-getnumb
            console.log(res)
